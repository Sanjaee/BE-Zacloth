...
// Enhanced security for user generation endpoints - very strict
const userGenerationSecurity = (req, res, next) => {
  const userAgent = req.get("User-Agent") || "";
  const referer = req.get("Referer") || "";
  const origin = req.get("Origin") || "";
  const accept = req.get("Accept") || "";
  ...
  if (isNextAuthRequest) {
    console.log("✅ ALLOWED - NextAuth User Generation Request:", {
      userAgent: userAgent.substring(0, 50) + "...",
      origin,
      ip: req.ip,
      timestamp: new Date().toISOString(),
  ...
  if (isBlockedUserAgent) {
    console.log("🚫 BLOCKED USER GENERATION ATTEMPT - External Tool:", {
      userAgent,
      ip: req.ip,
      url: req.url,
      timestamp: new Date().toISOString(),
    ...
    return res.status(403).json({
      success: false,
      message:
        "Access denied. User generation is only available through the web application.",
      code: "USER_GENERATION_EXTERNAL_ACCESS_DENIED",
    });
  }
  ...
  if (missingBrowserHeaders.length > 0) {
    console.log(
      "🚫 BLOCKED USER GENERATION ATTEMPT - Missing Browser Headers:",
      {
        missingHeaders: missingBrowserHeaders,
        userAgent,
        ip: req.ip,
    ...
    return res.status(403).json({
      success: false,
      message: "Access denied. Invalid request headers.",
      code: "USER_GENERATION_INVALID_HEADERS",
    });
  }
  ...
  if (
    ...
    console.log("🚫 BLOCKED USER GENERATION ATTEMPT - Non-Browser Headers:", {
      accept,
      acceptLanguage,
      acceptEncoding,
      connection,
    ...
    return res.status(403).json({
      success: false,
      message: "Access denied. Invalid browser headers.",
      code: "USER_GENERATION_NON_BROWSER_HEADERS",
    });
  }
  ...
  if (process.env.NODE_ENV === "production") {
    ...
    if (!isAllowedOrigin) {
      console.log("🚫 BLOCKED USER GENERATION ATTEMPT - Invalid Origin:", {
        origin,
        referer,
        userAgent,
        ip: req.ip,
      ...
      return res.status(403).json({
        success: false,
        message: "Access denied. Invalid origin.",
        code: "USER_GENERATION_INVALID_ORIGIN",
      });
    }
  }

  // Log successful security check
  console.log("✅ USER GENERATION SECURITY CHECK PASSED:", {
    userAgent: userAgent.substring(0, 100) + "...",
    ip: req.ip,
    timestamp: new Date().toISOString(),
  });
...
// Enhanced security for product creation endpoints - very strict
const productCreationSecurity = (req, res, next) => {
  const userAgent = req.get("User-Agent") || "";
  const referer = req.get("Referer") || "";
  const origin = req.get("Origin") || "";
  const accept = req.get("Accept") || "";
  ...
  if (isNextAuthRequest) {
    console.log("✅ ALLOWED - NextAuth Product Creation Request:", {
      userAgent: userAgent.substring(0, 50) + "...",
      origin,
      ip: req.ip,
      timestamp: new Date().toISOString(),
  ...
  if (isBlockedUserAgent) {
    console.log("🚫 BLOCKED PRODUCT CREATION ATTEMPT - External Tool:", {
      userAgent,
      ip: req.ip,
      url: req.url,
      timestamp: new Date().toISOString(),
    ...
    return res.status(403).json({
      success: false,
      message:
        "Access denied. Product creation is only available through the web application.",
      code: "PRODUCT_CREATION_EXTERNAL_ACCESS_DENIED",
    });
  }
  ...
  if (missingBrowserHeaders.length > 0) {
    console.log(
      "🚫 BLOCKED PRODUCT CREATION ATTEMPT - Missing Browser Headers:",
      {
        missingHeaders: missingBrowserHeaders,
        userAgent,
        ip: req.ip,
    ...
    return res.status(403).json({
      success: false,
      message: "Access denied. Invalid request headers.",
      code: "PRODUCT_CREATION_INVALID_HEADERS",
    });
  }
  ...
  if (
    ...
    console.log("🚫 BLOCKED PRODUCT CREATION ATTEMPT - Non-Browser Headers:", {
      accept,
      acceptLanguage,
      acceptEncoding,
      connection,
    ...
    return res.status(403).json({
      success: false,
      message: "Access denied. Invalid browser headers.",
      code: "PRODUCT_CREATION_NON_BROWSER_HEADERS",
    });
  }
  ...
  if (process.env.NODE_ENV === "production") {
    ...
    if (!isAllowedOrigin) {
      console.log("🚫 BLOCKED PRODUCT CREATION ATTEMPT - Invalid Origin:", {
        origin,
        referer,
        userAgent,
        ip: req.ip,
      ...
      return res.status(403).json({
        success: false,
        message: "Access denied. Invalid origin.",
        code: "PRODUCT_CREATION_INVALID_ORIGIN",
      });
    }
  }

  // Log successful security check
  console.log("✅ PRODUCT CREATION SECURITY CHECK PASSED:", {
    userAgent: userAgent.substring(0, 100) + "...",
    ip: req.ip,
    timestamp: new Date().toISOString(),
  });
